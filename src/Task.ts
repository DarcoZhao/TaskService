...
let Tasks= [
    {id:"task_00",name:"找到鸭子",desc:"请找到绿色的鸭子",status:1,fromNPCid:"npc_0",toNPCid:"npc_1",condition:new NPCTalkTaskCondition(),nexttaskid:"task_01"},
    {id:"task_01",name:"杀怪物",desc:"请杀死绿色的怪物",status:0,fromNPCid:"npc_1",toNPCid:"npc_1",condition:new KillMonsterTaskCondition(10),nexttaskid:null},
]

let NPCs=[
    {id:"npc_0",name:"你好！",wrod:"我只会说这一句话了哦！",photo:"npc0_01_png"},
    {id:"npc_1",name:"你好啊！",wrod:"别点了任务结束了！",photo:"npc1__01_png"},
]
